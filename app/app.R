...
# Define UI
ui <- navbarPage(
  "BC Socio-economic Status (SES) Index",
  tabPanel(
    "Home",
    h3("About this App"),
    p(
      "This Shiny app provides a user-friendly interface to explore the BC SES Index project data. The app has the following sections:"
    ),
    tags$ul(
      tags$li(
        tags$b("Data Cleaning:"),
        "Run the data cleaning scripts to process the raw data."
      ),
      tags$li(
        tags$b("Economic Indicators:"),
        "Visualize the trends and geographic distribution of various economic indicators."
      )
    ),
  ...
  tabPanel(
    ...
    sidebarLayout(
      ...
      mainPanel(
        ...
        p(
          "This section allows you to run the data cleaning scripts located in the 'src' directory. The scripts are executed in a predefined order to ensure data integrity."
        ),
        p(
          "The output and any potential errors from the scripts will be displayed in the 'Process Status' log in the sidebar."
        )
      )
    )
  ),
  tabPanel(
    ...
    tabsetPanel(
      tabPanel(
        ...
        p(
          "This section will display trends of various economic variables over time."
        ),
      ...
      tabPanel(
        ...
        p(
          "This section will display the geographic distribution of selected economic variables on a map."
        ),
